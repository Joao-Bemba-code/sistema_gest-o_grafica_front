    ...
    <div className="space-y-5">
      <div className="obsidian-glass rounded-lg p-5 mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 border-l-4 border-l-primary">
        ...
        <div className="flex flex-wrap gap-3">
          <button
            onClick={() => router.push("/maquinas/novo")}
            ...
            <div className="hidden lg:block overflow-x-auto">
                    ...
                    <tr key={m.id} className="border-b border-border/10 hover:bg-muted/30 transition-colors">
                      ...
                      <td className="px-5 py-3 text-right">
                        <div className="flex items-center justify-end gap-1">
                          <Button variant="ghost" size="icon" onClick={() => router.push(`/maquinas/${m.id}`)} title="Editar"><Icon name="edit" className="text-[16px]" /></Button>
              ...
              {filtrados.length === 0 && (
                <div className="p-12 text-center">
                  ...
                  <Button variant="outline" size="sm" className="mt-3" onClick={() => router.push("/maquinas/novo")}>
                ...
                <div key={m.id} className="p-4 hover:bg-muted/30 transition-colors">
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="flex flex-col gap-1 shrink-0">
                      <Button variant="ghost" size="icon" onClick={() => router.push(`/maquinas/${m.id}`)} title="Editar"><Icon name="edit" className="text-[14px]" /></Button>
